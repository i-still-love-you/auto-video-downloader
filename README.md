...
6. 자동 다운로드는 목록 페이지를 숨김 창(BrowserWindow, 이미지 비활성)에 로드해 DOM 에서 영상 링크와 다음 페이지를 찾고,
   ...
   다음 링크를 찾지 못하면(주소에 페이지 번호가 있으면 번호를 올려 한 번 더 시도) 끝냅니다.
