...
const PATHS: Record<string, string> = {
  ...
  layers: 'M12 2 1 7.5l11 5.5 11-5.5L12 2zm0 2.3 6.4 3.2L12 10.7 5.6 7.5 12 4.3zM3.3 11.2 1 12.4l11 5.5 11-5.5-2.3-1.2L12 15.6l-8.7-4.4zm0 4.5L1 16.9l11 5.5 11-5.5-2.3-1.2L12 20.1l-8.7-4.4z',
